"""Validate and preserve the human-approved V4.9e calibration workbook."""
...
SEED = ROOT / "benchmarks/verification_construction_v4_stage9e_fresh_calibration_workbook_v1.json"
DESTINATION = ROOT / "benchmarks/verification_construction_v4_stage9e_fresh_calibration_workbook_v1_APPROVED.json"
AUDIT = ROOT / "artifacts/evaluations/verification-construction-v4-stage9e-review-gate-v1.json"
...
def main() -> None:
    ...
    if len(submitted.cases) != 20:
        raise ValueError("V4.9e requires exactly 20 cases")
    ...
    audit = {
        "audit_id": "verification-construction-v4-stage9e-review-gate-v1",
        "status": "approved_awaiting_v4_9f_freeze",
        ...
        "next_action": "Freeze the V4.9f replacement calibration configuration before its one allowed execution",
    }
