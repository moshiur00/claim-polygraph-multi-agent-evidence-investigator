"""Run the post-remediation V3.5c temporal canary with a fresh receipt identity."""
...
MODEL = "gpt-5.6-luna"
CANARY_ID = "v3.5c-synthetic-temporal-canary-v1"
EXPERIMENT_ID = uuid5(NAMESPACE_URL, f"claim-polygraph/{CANARY_ID}")
CLAIM_TEXT = "Regulation Y began applying on 14 June 2019."
EVIDENCE_TEXT = "The official register states Regulation Y began applying on 14 June 2019."
...
async def main() -> None:
    ...
    ledger = SQLitePaidOperationLedger(root / "data/v3-stage5c-paid-operations.db")
    telemetry = TelemetryCollector(root / "data/v3-stage5c-telemetry.db")
    ...
    passed = result["disposition"] == "validated_proposal"
    artifact = {
        "artifact_id": "verification-construction-v3-stage5c-synthetic-canary-v1",
