"""Audit V4.9e fresh calibration collection before human review."""
...
from claim_polygraph_ng.evaluation.v3_annotation import load_replacement_calibration_workbook
...
def main() -> None:
    ...
    workbook_path = root / "benchmarks/verification_construction_v4_stage9e_fresh_calibration_workbook_v1.json"
    ...
    audit = {
        "audit_id": "verification-construction-v4-stage9e-collection-audit-v1",
    ...
    destination = root / "artifacts/evaluations/verification-construction-v4-stage9e-collection-audit-v1.json"
