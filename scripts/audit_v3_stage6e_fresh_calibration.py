"""Audit V3.6e fresh integrity and decide whether held-out may open."""
...
def main() -> None:
    ...
    if (
        ...
        raise ValueError("original held-out data crossed the V3.6e boundary")
    failed = [
    ...
    audit = {
        "audit_id": (
            "verification-construction-v3-stage6e-fresh-calibration-audit-v1"
        ),
